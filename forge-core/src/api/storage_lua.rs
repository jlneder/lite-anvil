...
pub fn register_preload(lua: &Lua) -> LuaResult<()> {
    ...
    preload.set(
        ...
        lua.create_function(|lua, ()| {
            ...
            storage.set(
                "save",
                lua.create_function(|lua, (module, key, value): (LuaString, LuaString, LuaValue)| {
