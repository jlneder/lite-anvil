...
pub fn register_preload(lua: &Lua) -> LuaResult<()> {
    ...
    preload.set(
        ...
        lua.create_function(|lua, ()| {
            ...
            regex.set(
                "find_offsets",
                lua.create_function(|lua, (pattern, str, offset, options): (LuaValue, LuaString, Option<i64>, Option<i64>)| {
                    let regex: LuaTable = lua
                        .globals()
                        .get::<LuaTable>("package")?
                        .get::<LuaTable>("loaded")?
            ...
            regex.set(
                ...
                lua.create_function(|lua, (pattern, str, offset, options): (LuaValue, LuaString, Option<i64>, Option<i64>)| {
                    ...
                    let res: LuaMultiValue = find_offsets_fn.call((
                        pattern,
                        str.clone(),
                        offset,
                        options,
            ...
            regex.set(
                ...
                lua.create_function(|lua, (pattern, str, offset, options): (LuaValue, LuaString, Option<i64>, Option<i64>)| {
                    ...
                    let res: LuaMultiValue = find_fn.call((pattern, str.clone(), offset, options))?;
                    let vals: Vec<LuaValue> = res.into_vec();
                    if vals.is_empty() {
                        return Ok(LuaMultiValue::new());
                    }
