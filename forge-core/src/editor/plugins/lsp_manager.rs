...
fn builtin_specs() -> Vec<Spec> {
    vec![
        ...
        Spec {
            name: "elixir_ls".to_string(),
            command: Value::Array(vec![
                Value::String("elixir-ls".to_string()),
            ]),
            filetypes: vec!["elixir".to_string()],
            root_patterns: vec![
                "mix.exs".to_string(),
                ".git".to_string(),
            ],
        ...
        Spec {
            name: "ocamllsp".to_string(),
            command: Value::Array(vec![
                Value::String("ocamllsp".to_string()),
            ]),
            filetypes: vec!["ocaml".to_string()],
            root_patterns: vec![
        ...
        Spec {
            name: "gleam_lsp".to_string(),
            command: Value::Array(vec![
                Value::String("gleam".to_string()),
                Value::String("lsp".to_string()),
            ]),
            filetypes: vec!["gleam".to_string()],
            root_patterns: vec![
        ...
        Spec {
            name: "erlang_ls".to_string(),
            command: Value::Array(vec![Value::String("erlang_ls".to_string())]),
            filetypes: vec!["erlang".to_string()],
            root_patterns: vec!["rebar.config".to_string(), "erlang.mk".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            ...
            command: Value::Array(vec![Value::String("clangd".to_string())]),
            filetypes: vec!["c".to_string(), "c++".to_string()],
            root_patterns: vec![".clangd".to_string(), "compile_commands.json".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "haskell_language_server".to_string(),
            command: Value::Array(vec![Value::String("haskell-language-server".to_string()), Value::String("--lsp".to_string())]),
            filetypes: vec!["haskell".to_string()],
            root_patterns: vec!["hie.yaml".to_string(), "package.yaml".to_string(), "stack.yaml".to_string(), "cabal.project".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "zls".to_string(),
            command: Value::Array(vec![Value::String("zls".to_string())]),
            filetypes: vec!["zig".to_string()],
            root_patterns: vec!["build.zig".to_string(), "zls.json".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "dart_language_server".to_string(),
            command: Value::Array(vec![Value::String("dart".to_string()), Value::String("language-server".to_string())]),
            filetypes: vec!["dart".to_string()],
            root_patterns: vec!["pubspec.yaml".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            ...
            command: Value::Array(vec![Value::String("metals".to_string())]),
            filetypes: vec!["scala".to_string()],
            root_patterns: vec!["build.sbt".to_string(), "pom.xml".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "sourcekit_lsp".to_string(),
            command: Value::Array(vec![Value::String("sourcekit-lsp".to_string())]),
            filetypes: vec!["swift".to_string()],
            root_patterns: vec!["Package.swift".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "ruby_lsp".to_string(),
            command: Value::Array(vec![Value::String("ruby-lsp".to_string())]),
            filetypes: vec!["ruby".to_string()],
            root_patterns: vec!["Gemfile".to_string(), ".ruby-version".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "julia_language_server".to_string(),
            command: Value::Array(vec![Value::String("julia".to_string()), Value::String("--startup-file=no".to_string()), Value::String("--history-file=no".to_string()), Value::String("-e".to_string()), Value::String("using LanguageServer; runserver()".to_string())]),
            filetypes: vec!["julia".to_string()],
            root_patterns: vec!["Project.toml".to_string(), "Manifest.toml".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "clojure_lsp".to_string(),
            command: Value::Array(vec![Value::String("clojure-lsp".to_string())]),
            filetypes: vec!["clojure".to_string()],
            root_patterns: vec!["deps.edn".to_string(), "project.clj".to_string(), "bb.edn".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "crystalline".to_string(),
            command: Value::Array(vec![Value::String("crystalline".to_string())]),
            filetypes: vec!["crystal".to_string()],
            root_patterns: vec!["shard.yml".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "lua_language_server".to_string(),
            command: Value::Array(vec![Value::String("lua-language-server".to_string())]),
            filetypes: vec!["lua".to_string()],
            root_patterns: vec![".luarc.json".to_string(), ".luarc.jsonc".to_string(), ".git".to_string()],
            initialization_options: None,
            settings: None,
            env: None,
        },
        Spec {
            name: "bash_language_server".to_string(),
            command: Value::Array(vec![Value::String("bash-language-server".to_string()), Value::String("start".to_string())]),
            filetypes: vec!["bash".to_string()],
